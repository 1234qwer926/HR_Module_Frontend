...
export default function ApplicationCreate() {
  ...
  const fetchJob = async () => {
    try {
      const response = await fetch(`https://studies-liabilities-concord-generation.trycloudflare.com/jobs/${jobId}`);
      if (response.ok) {
  ...
  const handleResumeUpload = async (file) => {
    ...
    try {
      ...
      const uploadResponse = await fetch('https://studies-liabilities-concord-generation.trycloudflare.com/upload-to-s3', {
        method: 'POST',
        body: formDataUpload,
      });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('https://studies-liabilities-concord-generation.trycloudflare.com/applications', {
        method: 'POST',
        headers: {
