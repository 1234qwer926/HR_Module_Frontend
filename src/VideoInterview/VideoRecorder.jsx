...
export default function VideoRecorder() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const appResponse = await fetch(`https://internship-produce-romantic-employees.trycloudflare.com/applications/${applicationId}`, {
      ...
      if (appResponse.ok) {
        ...
        const qResponse = await fetch(`https://internship-produce-romantic-employees.trycloudflare.com/jobs/${jobId}/video-questions`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
  ...
  const uploadVideo = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://internship-produce-romantic-employees.trycloudflare.com/video-responses', {
        method: 'POST',
        headers: {
