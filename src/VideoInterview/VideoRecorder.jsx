...
export default function VideoRecorder() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const appResponse = await fetch(`https://promptly-skill-employer-precisely.trycloudflare.com/applications/${applicationId}`, {
      ...
      if (appResponse.ok) {
        ...
        const qResponse = await fetch(`https://promptly-skill-employer-precisely.trycloudflare.com/jobs/${jobId}/video-questions`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
  ...
  const uploadVideo = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://promptly-skill-employer-precisely.trycloudflare.com/video-responses', {
        method: 'POST',
        headers: {
