...
export default function VideoReview() {
  ...
  const fetchVideos = async () => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/applications/${applicationId}/video-responses`, {
        headers: {
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://127.0.0.1:8000/video-responses/${currentVideo.id}`, {
        method: 'PUT',
        headers: {
        ...
        <Stack spacing="lg">
          ...
          <Paper p="md" withBorder style={{ backgroundColor: '#000' }}>
            <video
              ...
              src={`http://127.0.0.1:8000${currentVideo.video_path}`}
            />
          </Paper>
