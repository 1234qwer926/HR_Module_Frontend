...
export default function VideoReview() {
  ...
  const fetchVideos = async () => {
    try {
      ...
      const response = await fetch(`https://internship-produce-romantic-employees.trycloudflare.com/applications/${applicationId}/video-responses`, {
        headers: {
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://internship-produce-romantic-employees.trycloudflare.com/video-responses/${currentVideo.id}`, {
        method: 'PUT',
        headers: {
        ...
        <Stack spacing="lg">
          ...
          <Paper p="md" withBorder style={{ backgroundColor: '#000' }}>
            <video
              ...
              src={`https://internship-produce-romantic-employees.trycloudflare.com${currentVideo.video_path}`}
            />
          </Paper>
