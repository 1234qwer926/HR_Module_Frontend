...
const CATExam = () => {
  ...
  const fetchNextItem = async (sessionId) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://internship-produce-romantic-employees.trycloudflare.com/cat/next-item', { session_id: sessionId });
  ...
  const submitAnswer = async () => {
    ...
    try {
      const response = await axios.post('https://internship-produce-romantic-employees.trycloudflare.com/cat/submit-answer', {
  ...
  const completeExam = async (sessionId) => {
    try {
      ...
      const response = await axios.post('https://internship-produce-romantic-employees.trycloudflare.com/cat/complete', {
