...
const CATExam = () => {
  ...
  const fetchNextItem = async (sessionId) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://promptly-skill-employer-precisely.trycloudflare.com/cat/next-item', { session_id: sessionId });
  ...
  const submitAnswer = async () => {
    ...
    try {
      const response = await axios.post('https://promptly-skill-employer-precisely.trycloudflare.com/cat/submit-answer', {
  ...
  const completeExam = async (sessionId) => {
    try {
      ...
      const response = await axios.post('https://promptly-skill-employer-precisely.trycloudflare.com/cat/complete', {
